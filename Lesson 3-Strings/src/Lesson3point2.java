...
public class Lesson3point2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Word4.substring(0,6).toLowerCase()+ Word4.substring(6,10).toUpperCase()+ Word4.substring(10,14).toLowerCase()+"\\"+ Word4.substring(14,18).toUpperCase()+"\\"+" "+ Word4.substring(19,24).toLowerCase() + " "+ 4 );
		String Word5= "Peter Piper Picked A Peck of Pickled Peppers";
		System.out.println(Word5.substring(19,20)+ " "+ Word5.substring(21,37).toLowerCase()+"\t"+ Word5.substring(37,44).toLowerCase()+" "+ Word5.substring(0,12)+ "\t"+ Word5.substring(29,37).toLowerCase()+ "\t");
